...
square = Rectangle((0.80, 0.65 - 0.060), 0.160, 0.120, fill=True, color='violet', edgecolor='black', lw=2)
ax.add_patch(square)

# Add the letter "A" to the square
ax.text(0.88, 0.80 - 0.150, "G", color='black', fontsize=20, ha='center', va='center')
...
# plt.savefig('Nucleotide_G5.png', dpi=300, bbox_inches='tight')
