# Graph a phosphate group (1P, 4O, 2H)
...
# left_left_circle = plt.Circle((0.130, 0.500), H_radius, fill=True, color='gray', lw=2) # Hydrogen
...
# plt.savefig('Phosphate_group.png', dpi=300, bbox_inches='tight')
