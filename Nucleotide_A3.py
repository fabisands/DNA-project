...
square = Rectangle((0.04, 0.29), 0.160, 0.120, fill=True, color='lime', edgecolor='black', lw=2)
ax.add_patch(square)

# Add the letter "A" to the square
ax.text(0.12, 0.35, "A", color='black', fontsize=20, ha='center', va='center')
...
# plt.savefig('Nucleotide_A3.png', dpi=300, bbox_inches='tight')
